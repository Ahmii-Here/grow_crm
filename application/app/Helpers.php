 ...
 * @return string bootstrap label class
 */
function runtimeAppointmentStatusColors($value = '', $type = 'label') {

    //default colour
    $colour = 'default';

    //get the css value from config
    foreach (config('settings.appointment_statuses') as $key => $css) {
        if ($value == $key) {
            $colour = $css;
        }
    }
...
function runtimeAppointmentPriorityColors($value = '', $type = 'label') {

    //default colour
    $colour = 'default';

    //get the css value from config
    foreach (config('settings.appointment_priority') as $key => $css) {
        if ($value == $key) {
            $colour = $css;
        }
    }
...
function runtimeAppointmentsDefaults($check = '') {

    //tasks visible to clients
    if ($check == 'appointment_client_visibility') {
        return (config('system.settings_appointments_client_visibility') == 'visible') ? 'checked' : '';
    }
    //appointments visible to clients
    if ($check == 'appointment_billable') {
        return (config('system.settings_appointments_billable') == 'billable') ? 'checked' : '';
    }
...
function runtimeAppointmentDependencyLock($value = '') {
 ...
 * @param string $value determining value
 */
function runtimeAppointmentDependencyColors($value = '', $status = '') {
...
function runtimeAppointmentCompletedStatus($status = '') {
