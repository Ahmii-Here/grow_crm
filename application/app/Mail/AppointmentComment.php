...
/** --------------------------------------------------------------------------------
 * This classes renders the [appointment comment] email and stores it in the queue
 * @package    Grow CRM
 * @author     NextLoop
 *----------------------------------------------------------------------------------*/
...
class AppointmentComment extends Mailable {
    use Queueable;
    ...
    public function build() {
        ...
        //email template
        if (!$template = \App\Models\EmailTemplate::Where('emailtemplate_name', 'Appointment Comment')->first()) {
            return false;
        }
