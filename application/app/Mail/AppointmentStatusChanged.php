...
/** --------------------------------------------------------------------------------
 * This classes renders the [appointment status changed] email and stores it in the queue
 * @package    Grow CRM
 * @author     NextLoop
 *----------------------------------------------------------------------------------*/
...
class AppointmentStatusChanged extends Mailable {
    ...
    public function build() {
        ...
        //email template
        if (!$template = \App\Models\EmailTemplate::Where('emailtemplate_name', 'Appointment Status Change')->first()) {
            return false;
        }
