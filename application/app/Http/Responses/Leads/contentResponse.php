...
class contentResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if ($type == 'show-organisation') {
            $html = view('pages/lead/content/organisation/show', compact('lead','has_field','fields'))->render();
            $jsondata['dom_html'][] = [
                'selector' => '#card-leads-left-panel',
                'action' => 'replace',
                'value' => $html,
        ...
        if ($type == 'show-custom-fields') {
            $html = view('pages/lead/content/customfields/show', compact('lead', 'fields','progress'))->render();
            $jsondata['dom_html'][] = [
                'selector' => '#card-leads-left-panel',
                'action' => 'replace',
                'value' => $html,
         ...
         * -------------------------------------------------------------------------*/
        if ($type == 'show-notes') {
            $html = view('pages/lead/content/mynotes/show', compact('lead', 'notes', 'has_note'))->render();
            $jsondata['dom_html'][] = [
                'selector' => '#card-leads-left-panel',
                'action' => 'replace',
                'value' => $html,
        ...
        if ($type == 'show-appointments') {
            $html = view('pages/lead/content/appointments/show', compact('lead', 'appointments', 'has_appointment'))->render();
            $jsondata['dom_html'][] = [
                'selector' => '#card-leads-left-panel',
                'action' => 'replace',
                'value' => $html,
        ...
        if ($type == 'show-tasks') {
            $html = view('pages/lead/content/tasks/show', compact('lead', 'tasks', 'has_task'))->render();
            $jsondata['dom_html'][] = [
                'selector' => '#card-leads-left-panel',
                'action' => 'replace',
                'value' => $html,
        ...
        if ($type == 'edit-notes' || $type == 'create-notes') {
            $html = view('pages/lead/content/mynotes/edit', compact('lead', 'note', 'notes'))->render();
            $jsondata['dom_html'][] = [
                'selector' => '#card-leads-left-panel',
                'action' => 'replace',
                'value' => $html,
         ...
         * -------------------------------------------------------------------------*/
        if ($type == 'show-fields') {
            $html = view('pages/lead/content/myfields/show', compact('lead', 'fields', 'has_field'))->render();
            $jsondata['dom_html'][] = [
                'selector' => '#card-leads-left-panel',
                'action' => 'replace',
                'value' => $html,
         ...
         * show user fields
         * -------------------------------------------------------------------------*/
        if ($type == 'edit-fields' || $type == 'create-fields') {
            $html = view('pages/lead/content/myfields/edit', compact('lead', 'field', 'fields'))->render();
            $jsondata['dom_html'][] = [
                'selector' => '#card-leads-left-panel',
                'action' => 'replace',
                'value' => $html,
