...
class updateCustomFieldsResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //json output
        $html = view('pages/appointment/components/custom-fields', compact('appointment', 'fields'))->render();
        $jsondata['dom_html'][] = [
        ...
        //json output
        $html = view('pages/appointment/components/custom-fields-edit', compact('appointment', 'fields'))->render();
        $jsondata['dom_html'][] = [
