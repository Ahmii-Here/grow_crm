...
class AppointmentStoreUpdate extends FormRequest {
    ...
    public function rules() {
        ...
        $rules += [
            ...
            'appointment_date_due' => [
                ...
                'date',
                function ($attribute, $value, $fail) {
                    if ($value != '' && request('appointment_date_start') != '' && (strtotime($value) < strtotime(request('appointment_date_start')))) {
