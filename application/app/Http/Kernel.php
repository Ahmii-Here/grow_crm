...
class Kernel extends HttpKernel {
    ...
    protected $routeMiddleware = [
        ...
        //[growcrm] - [appointments]
        'appointmentsMiddlewareIndex' => \App\Http\Middleware\Appointments\Index::class,
        'appointmentsMiddlewareShow' => \App\Http\Middleware\Appointments\Show::class,
        'appointmentsMiddlewareCreate' => \App\Http\Middleware\Appointments\Create::class,
        'appointmentsMiddlewareDestroy' => \App\Http\Middleware\Appointments\Destroy::class,
        'appointmentsMiddlewareTimer' => \App\Http\Middleware\Appointments\Timer::class,
        'appointmentsMiddlewareEdit' => \App\Http\Middleware\Appointments\Edit::class,
        'appointmentsMiddlewareParticipate' => \App\Http\Middleware\Appointments\Participate::class,
        'appointmentsMiddlewareDeleteAttachment' => \App\Http\Middleware\Appointments\DeleteAttachment::class,
        'appointmentsMiddlewareDownloadAttachment' => \App\Http\Middleware\Appointments\DownloadAttachment::class,
        'appointmentsMiddlewareDeleteComment' => \App\Http\Middleware\Appointments\DeleteComment::class,
        'appointmentsMiddlewareEditDeleteChecklist' => \App\Http\Middleware\Appointments\EditDeleteChecklist::class,
        'appointmentsMiddlewareAssign' => \App\Http\Middleware\Appointments\Assign::class,
        'appointmentsMiddlewareCloning' => \App\Http\Middleware\Appointments\Cloning::class,
        'appointmentsMiddlewareManageDependencies' => \App\Http\Middleware\Appointments\ManageDependencies::class,
