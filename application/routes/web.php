...
Route::group(['prefix' => 'appointments'], function () {
    Route::any("/search", "Appointments@index");
    Route::any("/timer/{id}/start", "Appointments@timerStart")->where('id', '[0-9]+');
    Route::any("/timer/{id}/stop", "Appointments@timerStop")->where('id', '[0-9]+');
    Route::any("/timer/stop", "Appointments@timerStopUser");
    Route::any("/timer/{id}/stopall", "Appointments@timerStopAll")->where('id', '[0-9]+');
    Route::post("/delete", "Appointments@destroy")->middleware(['demoModeCheck']);
    Route::post("/{appointment}/toggle-status", "Appointments@toggleStatus")->where('appointment', '[0-9]+');
    Route::post("/{appointment}/update-description", "Appointments@updateDescription")->where('appointment', '[0-9]+');
    Route::post("/{appointment}/attach-files", "Appointments@attachFiles")->where('appointment', '[0-9]+');
    Route::delete("/delete-attachment/{uniqueid}", "Appointments@deleteAttachment")->middleware(['demoModeCheck']);
    Route::get("/download-attachment/{uniqueid}", "Appointments@downloadAttachment");
    Route::post("/{appointment}/post-comment", "Appointments@storeComment")->where('appointment', '[0-9]+');
    Route::delete("/delete-comment/{commentid}", "Appointments@deleteComment")->where('commentid', '[0-9]+');
    Route::post("/{appointment}/update-title", "Appointments@updateTitle")->where('appointment', '[0-9]+');
    Route::post("/{appointment}/add-checklist", "Appointments@storeChecklist")->where('appointment', '[0-9]+');
    Route::post("/update-checklist/{checklistid}", "Appointments@updateChecklist")->where('checklistid', '[0-9]+');
    Route::delete("/delete-checklist/{checklistid}", "Appointments@deleteChecklist")->where('checklistid', '[0-9]+');
    Route::post("/toggle-checklist-status/{checklistid}", "Appointments@toggleChecklistStatus")->where('checklistid', '[0-9]+');
    Route::post("/{appointment}/update-start-date", "Appointments@updateStartDate")->where('appointment', '[0-9]+');
    Route::post("/{appointment}/update-due-date", "Appointments@updateDueDate")->where('appointment', '[0-9]+');
    Route::post("/{appointment}/update-status", "Appointments@updateStatus")->where('appointment', '[0-9]+');
    Route::post("/{appointment}/update-priority", "Appointments@updatePriority")->where('appointment', '[0-9]+');
    Route::post("/{appointment}/update-visibility", "Appointments@updateVisibility")->where('appointment', '[0-9]+');
    Route::post("/{appointment}/update-milestone", "Appointments@updateMilestone")->where('appointment', '[0-9]+');
    Route::post("/{appointment}/update-assigned", "Appointments@updateAssigned")->where('appointment', '[0-9]+');
    Route::post("/{appointment}/update-tags", "Appointments@updateTags")->where('appointment', '[0-9]+');
    Route::post("/update-position", "Appointments@updatePosition");
    Route::any("/v/{appointment}/{slug}", "Appointments@index")->where('appointment', '[0-9]+');
    Route::any("/v/{appointment}", "Appointments@index")->where('appointment', '[0-9]+');
    Route::post("/{appointment}/update-custom", "Appointments@updateCustomFields")->where('appointment', '[0-9]+');
    Route::put("/{appointment}/archive", "Appointments@archive")->where('appointment', '[0-9]+');
    Route::put("/{appointment}/activate", "Appointments@activate")->where('appointment', '[0-9]+');
    Route::get("/{appointment}/clone", "Appointments@cloneTask")->where('appointment', '[0-9]+');
    Route::post("/{appointment}/clone", "Appointments@cloneStore")->where('appointment', '[0-9]+');
    Route::get("/{appointment}/recurring-settings", "Appointments@recurringSettings")->where('appointment', '[0-9]+');
    Route::post("/{appointment}/recurring-settings", "Appointments@recurringSettingsUpdate")->where('appointment', '[0-9]+');
    Route::get("/{appointment}/stop-recurring", "Appointments@stopRecurring")->where('appointment', '[0-9]+');
    Route::post("/{appointment}/add-dependency", "Appointments@storeDependency")->where('appointment', '[0-9]+');
    Route::delete("/{appointment}/delete-dependency", "Appointments@deleteDependency")->where('appointment', '[0-9]+');

    //card tabs
    Route::get("/content/{appointment}/show-main", "Appointments@show")->where('lead', '[0-9]+');
    Route::get("/content/{appointment}/show-customfields", "Appointments@showCustomFields")->where('appointment', '[0-9]+');
    Route::get("/content/{appointment}/edit-customfields", "Appointments@editCustomFields")->where('appointment', '[0-9]+');
    Route::post("/content/{appointment}/edit-customfields", "Appointments@updateCustomFields")->where('appointment', '[0-9]+');
    Route::get("/content/{appointment}/show-mynotes", "Appointments@showMyNotes")->where('appointment', '[0-9]+');
    Route::get("/content/{appointment}/create-mynotes", "Appointments@createMyNotes")->where('appointment', '[0-9]+');
    Route::get("/content/{appointment}/edit-mynotes", "Appointments@editMyNotes")->where('appointment', '[0-9]+');
    Route::delete("/content/{appointment}/delete-mynotes", "Appointments@deleteMyNotes")->where('appointment', '[0-9]+');
    Route::post("/content/{appointment}/edit-mynotes", "Appointments@updateMyNotes")->where('appointment', '[0-9]+');
...
Route::group(['prefix' => 'leads'], function () {
    ...
    // Appointment
    Route::get("/content/{lead}/show-appointments", "Leads@showMyAppointments")->where('lead', '[0-9]+');
    // Tasks
    Route::get("/content/{lead}/show-tasks", "Leads@showMyTasks")->where('lead', '[0-9]+');
    ...
    Route::get("/content/{lead}/edit-mynotes/{noteId}", "Leads@editMyNotes")->where('lead', '[0-9]+');
    Route::delete("/content/{lead}/delete-mynotes/{noteId}", "Leads@deleteMyNotes")->where('lead', '[0-9]+');
    Route::post("/content/{lead}/edit-mynotes/{noteId?}", "Leads@updateMyNotes")->where('lead', '[0-9]+');

    Route::get("/content/{lead}/show-myfields", "Leads@showMyFields")->where('lead', '[0-9]+');
    Route::get("/content/{lead}/create-myfields", "Leads@createMyFields")->where('lead', '[0-9]+');
    Route::get("/content/{lead}/edit-myfields/{fieldId}", "Leads@editMyFields")->where('lead', '[0-9]+');
    Route::delete("/content/{lead}/delete-myfields/{fieldId}", "Leads@deleteMyFields")->where('lead', '[0-9]+');
    Route::post("/content/{lead}/edit-myfields/{fieldId?}", "Leads@updateMyFields")->where('lead', '[0-9]+');
...
Route::group(['prefix' => 'settings/appointments'], function () {
    Route::get("/", "Settings\Appointments@index");
    Route::put("/", "Settings\Appointments@update")->middleware(['demoModeCheck']);

    Route::get("/statuses", "Settings\Appointments@statuses");
    Route::put("/statuses", "Settings\Appointments@updateStatuses")->middleware(['demoModeCheck']);
    Route::get("/statuses/{id}/edit", "Settings\Appointments@editStatus")->where('task', '[0-9]+');
    Route::put("/statuses/{id}", "Settings\Appointments@updateStatus")->where('task', '[0-9]+')->middleware(['demoModeCheck']);
    Route::get("/statuses/create", "Settings\Appointments@createStatus");
    Route::post("/statuses/create", "Settings\Appointments@storeStatus");
    Route::get("/move/{id}", "Settings\Appointments@move")->where('id', '[0-9]+');
    Route::put("/move/{id}", "Settings\Appointments@updateMove")->where('id', '[0-9]+');
    Route::delete("/statuses/{id}", "Settings\Appointments@destroyStatus")->where('id', '[0-9]+')->middleware(['demoModeCheck']);
    Route::post("/update-stage-positions", "Settings\Appointments@updateStagePositions");

    Route::get("/priorities", "Settings\Appointments@priorities");
    Route::put("/priorities", "Settings\Appointments@updatePriorities")->middleware(['demoModeCheck']);
    Route::get("/priorities/{id}/edit", "Settings\Appointments@editPriority")->where('task', '[0-9]+');
    Route::put("/priorities/{id}", "Settings\Appointments@updatePriority")->where('task', '[0-9]+')->middleware(['demoModeCheck']);
    Route::get("/priorities/create", "Settings\Appointments@createPriority");
    Route::post("/priorities/create", "Settings\Appointments@storePriority");
    Route::delete("/priorities/{id}", "Settings\Appointments@destroyPriority")->where('id', '[0-9]+')->middleware(['demoModeCheck']);
    Route::get("/move/priority/{id}", "Settings\Appointments@movePriority")->where('id', '[0-9]+');
    Route::put("/move/priority/{id}", "Settings\Appointments@updatePriorityMove")->where('id', '[0-9]+');
    Route::delete("/priorities/{id}", "Settings\Appointments@destroyPriority")->where('id', '[0-9]+')->middleware(['demoModeCheck']);
    Route::post("/update-priority-positions", "Settings\Appointments@updatePriorityPositions");
...
Route::group(['prefix' => 'settings/customfields'], function () {
    ...
    Route::get("/appointments", "Settings\Customfields@showAppointment");
    Route::put("/appointments", "Settings\Customfields@updateAppointment");
