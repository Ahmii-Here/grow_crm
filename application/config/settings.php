...
return [
    ...
    /**
     * Various appointment statuses, with their corresponding bootstrap colors (colors are used for labels etc)
     * The following colors are available: (default|info|warning|success|danger|primary|green|lime|brown)
     * [IMPORTANT WARNING]
     * Only change the color values
     */
    ...
    /**
     * Various appointment priority, with their corresponding bootstrap colors (colors are used for labels etc)
     * The following colors are available: (default|info|warning|success|danger|primary|green|lime|brown)
     * [IMPORTANT WARNING]
     * Only change the color values
     * normal | high | urgent
    ...
    'notifiable_events' => [
        ...
        'event_team_appointment_status_change' => true,
    ...
    'default_notifications_client' => [
        ...
        'notifications_appointments_activity' => 'yes_email',
