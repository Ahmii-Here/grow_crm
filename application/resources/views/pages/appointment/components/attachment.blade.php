...
<div class="col-sm-12" id="card_attachment_{{ $attachment->attachment_uniqiueid }}">
    <div class="file-attachment">
        ...
        @else
        <div class="x-image"> 
            <a class="preview-image-thumb" href="appointments/download-attachment/{{ $attachment->attachment_uniqiueid }}" download>
        ...
        <div class="x-details">
            ...
            <div class="x-actions"><strong>
                    <!--action: download-->
                    <a href="appointments/download-attachment/{{ $attachment->attachment_uniqiueid }}" download>{{ cleanLang(__('lang.download')) }} <span
                ...
                <span> |
                    <a href="javascript:void(0)" class="text-danger js-delete-ux-confirm confirm-action-danger"
                        ...
                        data-url="{{ urlResource('/appointments/delete-attachment/'.$attachment->attachment_uniqiueid) }}">{{ cleanLang(__('lang.delete')) }}</a></span>
                @endif
            </div>
        </div>
    </div>
