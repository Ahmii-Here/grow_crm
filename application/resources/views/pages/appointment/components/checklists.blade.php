<div class="card-checklist" id="card-checklist">
    ...
    <div class="progress" id="card-checklist-progress-container">
            @include('pages.appointment.components.progressbar')
    </div>
    ...
    <div class="x-action">
        <a href="javascript:void(0)" class="js-card-checklist-toggle" id="card-checklist-add-new"
            data-action-url="{{ urlResource('/appointments/'.$appointment->appointment_id.'/add-checklist') }}" data-toggle="new">{{ cleanLang(__('lang.add_new_item')) }}</a>
    </div>
    @endif
</div>