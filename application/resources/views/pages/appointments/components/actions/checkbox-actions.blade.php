@if(isset($page['page']) && $page['page'] == 'appointments')
<div class="col-md-12 col-lg-7 align-self-center hidden checkbox-actions" id="appointments-checkbox-actions-container">
    <!--button-->
    ...
    <div class="x-buttons">
        ...
        <button type="button"
            ...
            data-url="{{ urlResource('/appointments/change-category') }}"
            data-action-url="{{ urlResource('/appointments/change-category?type=bulk') }}" data-action-method="POST"
            data-action-type="form" data-action-form-id="main-body" data-loading-target="actionsModalBody"
            data-skip-checkboxes-reset="TRUE" id="checkbox-actions-change-category-appointments">
