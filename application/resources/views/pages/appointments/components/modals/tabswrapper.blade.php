<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            ...
            <div class="col-6">
                <select class="select2-basic form-control form-control-sm" id="appointment_recurring_period"
                    ...
                    <option value="day" {{ runtimePreselected($appointment->appointment_recurring_period ?? '', 'day') }}>{{ cleanLang(__('lang.days')) }}
                    </option>
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ cleanLang(__('lang.next_appointment_date')) }}</label> 
            <div class="col-sm-12 col-lg-3">
        ...
        <!--appointmenting cycles information-->
        <div class="alert alert-info">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span
                    aria-hidden="true">×</span> </button>
            <h5 class="text-info"><i class="sl-icon-info"></i> {{ cleanLang(__('lang.first_appointment')) }}</h5>
            <div>{{ cleanLang(__('lang.appointment_recurring_cycles_explanation_3')) }}</div>
        </div>
        ...
        <div class="alert alert-info">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span
                    aria-hidden="true">×</span> </button>
            <h5 class="text-info"><i class="sl-icon-info"></i> {{ cleanLang(__('lang.next_appointment_date')) }}</h5>
            <div>{{ cleanLang(__('lang.appointment_recurring_cycles_explanation_1')) }}</div>
        </div>
        ...
        <div class="alert alert-info hidden">
            ...
            <div>{{ cleanLang(__('lang.appointment_recurring_cycles_explanation_2')) }}</div>
        </div>
