...
<div class="modal-selector p-t-30 p-b-1 m-b-30">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-lg-9">
            <select
                ...
                id="project_id" name="project_id" data-milestones-dropdown="appointment_milestoneid"
                data-ajax--url="{{ url('/') }}/feed/clone-appointment-projects">
                <option value="{{ $appointment->project_id }}">{{ $appointment->project_title }}</option>
            </select>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-lg-9">
            <select class="select2-basic form-control form-control-sm" id="appointment_milestoneid" name="appointment_milestoneid">
                <option value="{{ $appointment->milestone_id }}">{{ $appointment->milestone_title }}</option>
            </select>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-lg-9">
            <select class="select2-basic form-control form-control-sm select2-preselected" id="appointment_status"
                name="appointment_status" data-preselected="{{ $appointment->appointment_status }}">
