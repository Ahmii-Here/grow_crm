...
<div class="hidden p-t-10" id="toogle_more_information">
    ...
    {{-- CLONE FIELDS --}}
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label text-left">@lang('lang.copy_fields')</label>
        <div class="col-2 text-right p-t-5">
            <input type="checkbox" id="copy_fields" name="copy_fields" class="filled-in chk-col-light-blue" checked>
            <label class="p-l-30" for="copy_fields"></label>
        </div>
    </div>
