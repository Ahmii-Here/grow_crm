    ...
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <select class="select2-basic form-control form-control-sm select2-new-options" id="lead_title"
                    name="lead_title">
                    <option value="">Select </option>
                    @foreach (['Private','LA Flex','GBIS','ECO4'] as $item)
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control alpha form-control-sm" id="lead_firstname" name="lead_firstname"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control alpha form-control-sm" id="lead_lastname" name="lead_lastname"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control digits form-control-sm" id="lead_phone" required name="lead_phone" placeholder=""
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="email" class="form-control form-control-sm" id="lead_email" name="lead_email" placeholder=""
        ...
        <div class="form-group row d-none">
            ...
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ cleanLang(__('lang.lead_value')) }} </label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ cleanLang(__('lang.lead_value')) }}</label>
            @if(config('system.settings_leads_allow_new_sources') == 'yes')
            <!--existing-->
            <div class="col-sm-12 col-lg-9">
                <select class="select2-basic form-control form-control-sm lead-source-select  select2-new-options" id="lead_source"
                    name="lead_source">
                    <option value=""></option>
            ...
            <!--existing-->
            <div class="col-sm-12 col-lg-9">
                <select class="select2-basic form-control form-control-sm lead-source-select" id="lead_source" name="lead_source">
                    @foreach($sources as $source)
                    @php $sourcelist[] = $source->leadsources_title;@endphp
                    <option value="{{ $source->leadsources_title }}"
                        {{ runtimePreselected($lead->lead_source ?? '', $source->leadsources_title) }}>{{
        ...
        <div class="form-group row other-field d-none">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ cleanLang(__('lang.other')) }}*</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="lead_source" placeholder="">
            </div>
        </div>
        ...
        <div class="hidden" id="add_lead_address_section">
            ...
            <div class="form-group row ">
                <label
                    class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ cleanLang(__('lang.postcode')) }}</label>
                <div class="col-sm-12 col-lg-9">
