    ...
    <div class="card">
        <div class="card card-body mailbox m-b-0">
            ...
            <div class="message-center dashboard-projects-admin">
                ...
                <a href="/leads?checklist={{ $name }}" target="_blank">
                    <div class="btn label-default btn-circle">{{ $payload['count_leads'][$name]['count'] }}</div>
                    <div class="mail-contnet">
                        <h5>{{ cleanLang(__($name)) }}</h5> 
                    </div>
                </a>
                @endforeach
            </div>
            <div class="message-center dashboard-projects-admin d-none">
                <!-- not started -->
