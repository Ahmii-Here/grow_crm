<!--heading-->
<div class="x-heading p-t-10"><i class="mdi mdi-file-document-box d-none"></i>{{ cleanLang(__('lang.organisation')) }}</div>
<div class="x-heading p-t-10"><i class="mdi mdi-file-document-box"></i>Project Overview</div>
...
<div class="card-show-form-data " id="card-lead-organisation">
    ...
    <!--company name-->
    <div class="form-data-row d-none">
    ...
    <div class="form-data-row">
        <span class="x-data-title d-none">{{ cleanLang(__('lang.street')) }}:</span>
        <span class="x-data-title">{{ cleanLang(__('lang.address')) }}:</span>
    ...
    <!--zip-->
    <div class="form-data-row ">
        <span class="x-data-title">{{ cleanLang(__('lang.postcode')) }}:</span>
    ...
    <!--checklist-->
    @include('pages.lead.content.myfields.show')
</div>
