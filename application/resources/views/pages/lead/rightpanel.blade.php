    ...
    <div class="x-section">
        ...
        <div class="x-element" id="card-lead-source"><i class="mdi mdi-magnify-plus"></i>
            <span>{{ cleanLang(__('lang.lead_value')) }}:
            </span>
            @if($lead->permission_edit_lead)
        ...
        <!--value-->
        <div class="x-element d-none"><i class="mdi mdi-cash-multiple"></i> <span>{{ cleanLang(__('lang.value')) }}: </span>
            @if($lead->permission_edit_lead)
        ...
        <!--last contacted-->
        <div class="x-element d-none" id="lead-contacted"><i class="mdi mdi-message-text"></i>
        ...
        <div class="x-element">
            <a href="{{ url('/appointments') }}" target="_blank">
                <span class="x-highlight">{{ cleanLang(__('lang.appointment')) }}</span>
            </a>
        </div>
        <div class="x-element">
            <a href="{{ url('/tasks') }}" target="_blank">
                <span class="x-highlight">{{ cleanLang(__('lang.task')) }}</span>
            </a>
        </div>
    ...
    <!----------tags----------->
    <div class="card-tags-container d-none" id="card-tags-container">
