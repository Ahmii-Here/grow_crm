    ...
    <form>
        <table id="demo-foo-addrow" class="table m-t-0 m-b-0 table-hover no-wrap app-modules" data-page-size="10">
            ...
            <tbody>
                ...
                <!--appointments-->
                <tr>
                    <td>@lang('lang.appointments')</td>
                    <td>
                        <div class="form-group form-group-checkbox m-0 p-0">
                            <div class="col-2 text-right m-0 p-0">
                                <input type="checkbox" id="settings_modules_appointments" name="settings_modules_appointments"
                                    {{ runtimePrechecked($settings->settings_modules_appointments) }}
                                    class="filled-in chk-col-light-blue">
                                <label class="m-0 p-0" for="settings_modules_appointments"></label>
                            </div>
                        </div>
                    </td>
                </tr>
