        ...
        <div class="table-responsive">
            <table class="table table-bordered w-99">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ cleanLang(__('lang.appointments')) }}</td>
                        <td>
                            <div class="form-group row m-0">
                                <div class="col-12 text-center">
                                    <select class="select2-basic form-control form-control-sm" name="role_appointments"
                                        data-allow-clear="false">
                                        <option value="0" {{ runtimePreselected($role->role_appointments ?? '', 0) }}>
                                            {{ cleanLang(__('lang.none')) }}</option>
                                        <option value="1" {{ runtimePreselected($role->role_appointments ?? '', 1) }}>
                                            {{ cleanLang(__('lang.view')) }}</option>
                                        <option value="2" {{ runtimePreselected($role->role_appointments ?? '', 2) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }}</option>
                                        <option value="3" {{ runtimePreselected($role->role_appointments ?? '', 3) }}>
                                            {{ cleanLang(__('lang.view')) }} + {{ cleanLang(__('lang.add')) }} +
                                            {{ cleanLang(__('lang.edit')) }} +
                                            {{ cleanLang(__('lang.delete')) }}</option>
                                    </select>
                        ...
                        <td>
                            <div class="form-group form-group-checkbox row m-0 w-98">
                                <div class="col-12 text-center p-t-5">
                                    <input type="checkbox" id="role_appointments_scope" name="role_appointments_scope"
                                        class="filled-in chk-col-light-blue"
                                        {{ runtimePrechecked($role->role_appointments_scope ?? '') }}>
                                    <label for="role_appointments_scope"></label>
                                </div>
                            </div>
                        </td>
                    </tr>
