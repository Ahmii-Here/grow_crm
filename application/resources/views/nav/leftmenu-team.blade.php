    ...
    <div class="scroll-sidebar" id="main-scroll-sidebar">
        ...
        <nav class="sidebar-nav" id="main-sidenav">
                ...
                <li data-modular-id="main_menu_team_leads"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        @foreach (\App\Models\LeadStatus::all() as $status)
                            <li class="sidenav-submenu {{ (request()->query('filter_lead_status')[0] ?? '') == $status->leadstatus_id ? 'active' : '' }}">
                                <a href="{{ _url('/leads?filter_lead_status[]=' .$status->leadstatus_id) }}" class="{{ (request()->query('filter_lead_status')[0] ?? '') == $status->leadstatus_id ? 'active' : '' }}">{{ cleanLang(__($status->leadstatus_title)) }}</a>
                            </li>
                        @endforeach
                    </ul>
                </li>
            ...
            <script>
                ...
                <ul aria-expanded="false" class="collapse-extra-added d-none">
                ...
                <!--projects[done]-->
                @if(config('visibility.modules.projects') && 1==2)
                ...
                <li data-modular-id="appointments"
                    class="sidenav-menu-item {{ $page['appointments'] ?? '' }} menu-tooltip menu-with-tooltip"
                    title="{{ cleanLang(__('lang.appointments')) }}" style="    text-wrap: nowrap;">
                    <a class="waves-effect waves-dark" href="/appointments" aria-expanded="false" target="_self">
                        <i class="ti-menu-alt"></i>
                        <span class="hide-menu">{{ cleanLang(__('lang.appointments')) }}
                        </span>
                    </a>
                </li>
                @endif
                ...
                config('visibility.modules.proposals')]) && 1==2)
                ...
                <!--proposals [multiple]-->
                @if(config('visibility.modules.proposals') && auth()->user()->role->role_templates_proposals > 0 && 1==2)
                <!--multipl menu-->
                ...
                <!--tickets-->
                @if(config('visibility.modules.tickets') && 1==2)
                ...
                <!--knowledgebase-->
                @if(config('visibility.modules.knowledgebase') && 1==2)
